...
describe('Emplacement e2e test', () => {
  ...
  it('should load Emplacements', async () => {
    ...
    expect(await emplacementComponentsPage.getTitle()).to.eq('bibliotechApp.emplacement.home.title');
    await browser.wait(
  ...
  it('should load create Emplacement page', async () => {
    ...
    expect(await emplacementUpdatePage.getPageTitle()).to.eq('bibliotechApp.emplacement.home.createOrEditLabel');
  ...
  it('should delete last Emplacement', async () => {
    ...
    expect(await emplacementDeleteDialog.getDialogTitle()).to.eq('bibliotechApp.emplacement.delete.question');
