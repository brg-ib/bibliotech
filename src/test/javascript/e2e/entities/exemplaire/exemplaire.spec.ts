...
describe('Exemplaire e2e test', () => {
  ...
  it('should load Exemplaires', async () => {
    ...
    expect(await exemplaireComponentsPage.getTitle()).to.eq('bibliotechApp.exemplaire.home.title');
  ...
  it('should load create Exemplaire page', async () => {
    ...
    expect(await exemplaireUpdatePage.getPageTitle()).to.eq('bibliotechApp.exemplaire.home.createOrEditLabel');
  ...
  it('should delete last Exemplaire', async () => {
    ...
    expect(await exemplaireDeleteDialog.getDialogTitle()).to.eq('bibliotechApp.exemplaire.delete.question');
