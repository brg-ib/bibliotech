...
describe('Auteur e2e test', () => {
  ...
  it('should load Auteurs', async () => {
    ...
    expect(await auteurComponentsPage.getTitle()).to.eq('bibliotechApp.auteur.home.title');
  ...
  it('should load create Auteur page', async () => {
    ...
    expect(await auteurUpdatePage.getPageTitle()).to.eq('bibliotechApp.auteur.home.createOrEditLabel');
  ...
  it('should delete last Auteur', async () => {
    ...
    expect(await auteurDeleteDialog.getDialogTitle()).to.eq('bibliotechApp.auteur.delete.question');
