...
describe('Theme e2e test', () => {
  ...
  it('should load Themes', async () => {
    ...
    expect(await themeComponentsPage.getTitle()).to.eq('bibliotechApp.theme.home.title');
  ...
  it('should load create Theme page', async () => {
    ...
    expect(await themeUpdatePage.getPageTitle()).to.eq('bibliotechApp.theme.home.createOrEditLabel');
  ...
  it('should delete last Theme', async () => {
    ...
    expect(await themeDeleteDialog.getDialogTitle()).to.eq('bibliotechApp.theme.delete.question');
