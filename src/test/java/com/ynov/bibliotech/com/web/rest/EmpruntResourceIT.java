...
import com.ynov.bibliotech.com.repository.EmpruntRepository;
...
public class EmpruntResourceIT {
    ...
    private static final Instant DEFAULT_DATE_EMPRUNT = Instant.ofEpochMilli(0L);
    private static final Instant UPDATED_DATE_EMPRUNT = Instant.now().truncatedTo(ChronoUnit.MILLIS);
