...
describe('Livre e2e test', () => {
  ...
  it('should load Livres', async () => {
    ...
    expect(await livreComponentsPage.getTitle()).to.eq('bibliotechApp.livre.home.title');
  ...
  it('should load create Livre page', async () => {
    ...
    expect(await livreUpdatePage.getPageTitle()).to.eq('bibliotechApp.livre.home.createOrEditLabel');
  ...
  it('should delete last Livre', async () => {
    ...
    expect(await livreDeleteDialog.getDialogTitle()).to.eq('bibliotechApp.livre.delete.question');
