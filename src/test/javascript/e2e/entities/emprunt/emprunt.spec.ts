...
describe('Emprunt e2e test', () => {
  ...
  it('should load Emprunts', async () => {
    ...
    expect(await empruntComponentsPage.getTitle()).to.eq('bibliotechApp.emprunt.home.title');
  ...
  it('should load create Emprunt page', async () => {
    ...
    expect(await empruntUpdatePage.getPageTitle()).to.eq('bibliotechApp.emprunt.home.createOrEditLabel');
  ...
  it('should create and save Emprunts', async () => {
    ...
    await promise.all([
      ...
      empruntUpdatePage.utilisateurSelectLastOption(),
  ...
  it('should delete last Emprunt', async () => {
    ...
    expect(await empruntDeleteDialog.getDialogTitle()).to.eq('bibliotechApp.emprunt.delete.question');
